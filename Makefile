...
NATIVE_GROUPS := files files-index web shell code code-graph code-graph-git environment scm snapshots
...
NATIVE_CRATES := workcell-mcp-files workcell-mcp-web workcell-mcp-shell workcell-mcp-code workcell-mcp-code-graph workcell-environment workcell-workspace-scm workcell-workspace-snapshot
